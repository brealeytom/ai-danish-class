...
def process_csv_to_audio(csv_filename, output_filename="final_output.mp3", chunk_duration_sec=600):
    ...
    try:
        ...
        for i, entry in enumerate(entries):
            ...
            pause_duration = int(float(entry['after_pause_len']))  # Convert to milliseconds
            if pause_duration > 0:
...
if __name__ == "__main__":
    process_csv_to_audio("input.csv", chunk_duration_sec=600)  # Adjust chunk size as needed
